...
public class TreeSet01 {
    ...
    TreeSet: If you need to use unique elements in a natural order that you sed tree set.
     it will be sort the elements in ascending order.

      HashSet.: If you need to use unique elements in a without natural order that you sed tree set.
      hashSet is faster than TreeSet but Tree set ake order.
